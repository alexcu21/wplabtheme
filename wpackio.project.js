...
module.exports = {
	// Project Identity
	appName: 'wpLabTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'wplabtheme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
